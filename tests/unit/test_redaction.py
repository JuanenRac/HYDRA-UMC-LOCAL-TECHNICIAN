# =============================================================================
# HYDRA-UMC-LOCAL-TECHNICIAN - tests/unit/test_redaction.py
# Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
# GPL-3.0 - see LICENSE
# =============================================================================
import unittest

from hydra_umc_local_technician.knowledge.redaction import redact_lines, redact_secrets
...
class RedactSecretsTests(unittest.TestCase):
    ...
    # regression: a review found these 3 real shapes escaping
    ...
    def test_a_secret_nested_one_level_deeper_as_a_json_object_is_redacted(self):
        # (P1,
        # residual outside this project's own three original examples): the
