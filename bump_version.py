#!/usr/bin/env python3
# =============================================================================
# HYDRA-UMC-LOCAL-TECHNICIAN - bump_version.py
# Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
# GPL-3.0 - see LICENSE
#
# Applies the ecosystem-wide "odometer" version bump to this project's own
# pyproject.toml (and its mirrored src/hydra_umc_local_technician/__init__.py)
...
INIT_FILE = ROOT / "src" / "hydra_umc_local_technician" / "__init__.py"
